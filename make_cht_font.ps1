$src = Get-Content ".\main\lcd_menu.h" -Encoding UTF8 -Raw
...
(@("32-128") + ($uniChars | ForEach-Object { '$' + ([Uint32]([char]$_)).ToString('X4') })) -join ",`n" | 
    Out-File "C:\Users\zhao_rui\Documents\Arduino\libraries\U8g2\tools\font\build\chinese1.map" -Encoding utf8
## 依列舉字元表，製作 u8g2_font_unifont_t_chinese1 陣列宣告
& C:\Users\zhao_rui\Documents\Arduino\libraries\U8g2\tools\font\bdfconv\bdfconv.exe -v C:\Users\zhao_rui\Documents\Arduino\libraries\U8g2\tools\font\bdf\unifont.bdf -b 0 -f 1 -M C:\Users\zhao_rui\Documents\Arduino\libraries\U8g2\tools\font\build\chinese1.map -d C:\Users\zhao_rui\Documents\Arduino\libraries\U8g2\tools\font\bdf\7x13.bdf -n u8g2_font_unifont_t_chinese1 -o u8g2_font_unifont.c
...
Get-ChildItem C:\Users\zhao_rui\Documents\Arduino\libraries\U8g2\src\clib -Recurse -Filter u8g2_fonts.c | ForEach-Object {
